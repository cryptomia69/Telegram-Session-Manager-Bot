...
from telethon.tl.types import Message, InputPeerChannel, InputChannel

api_id = 25311593  # Your Telegram API ID
api_hash = '4a552211f7d23d042f9f33155beba5f3'  # Your Telegram API hash
    ...
    for session_file in list_sessions():
        ...
        with client:
            try:
                ...
                if message:
                    client.send_reaction(post_link, '👍')  # React with a thumbs-up emoji
                    print(f"Reacted to post {post_link} using session {session_file}")
            except Exception as e:
