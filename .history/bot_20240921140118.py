...
api_id = 25311593  # Replace with your API ID
api_hash = '4a552211f7d23d042f9f33155beba5f3'  # Replace with your API hash
        ...
        for session_file in list_sessions():
            ...
            with client:
                try:
                    ...
                    # Send reaction (fire emoji) to the message
                    client(SendReaction(
                        peer=entity,
                        msg_id=message_id,
                        reaction=[ReactionEmoji(emoticon="🔥")]
                    ))
                    print(f"Reacted with fire emoji on post {post_link} using session {session_file}")
                except Exception as e:
